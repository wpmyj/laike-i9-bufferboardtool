...
void Gui_StrCenters(u16 x,u16 xe, u16 y, u16 fc, u16 bc, u8 *str,u8 size,u8 mode)
{
	u16 len=strlen((const char *)str);
	//u16 x1=(lcddev.width-len*8)/2;
	u16 x1=(((xe - x) - len*8)/2) + x;
	Show_Str(x1,y,fc,bc,str,size,mode);
} 
...
void Gui_DrawFont_Num16(u16 x, u16 y, u16 fc, u16 bc, u16 num)//开始位置   数字
{
	unsigned char n;
	unsigned char mflag = 0;
	u16 mcont;
	unsigned char nums[5] = {0,0,0,0,0,};
	unsigned char str[5] = {' ',' ',' ',' ',' ',};
